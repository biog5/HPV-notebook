...
#output_file = "archivo_salida2.blast"

#run_blast(query_file, subject_file, output_file)
# Ten en cuenta que esta función utiliza BLASTN para secuencias de ADN. Si necesitas utilizar otro programa de BLAST, cambia el valor de 'PROGRAM' en el diccionario payload.
